"""model now has creation date time and is_active flag and allowemaillogin for User model

Revision ID: db543c6fde5a
Revises: 
Create Date: 2019-05-16 16:27:45.231426
